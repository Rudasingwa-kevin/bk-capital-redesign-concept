      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-8 py-16">
        <div className="flex flex-col md:flex-row items-start justify-between gap-8">
          <div className="max-w-[320px]">
            ...
            <p className="text-[14px] leading-[20px] text-white/40">Rwanda&apos;s leading investment bank and fund manager. A subsidiary of BK Group PLC.</p>
          </div>
        ...
        <div className="mt-12 pt-6 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="text-[12px] text-white/30">&copy; {new Date().getFullYear()} BK Capital Limited. All rights reserved.</div>
